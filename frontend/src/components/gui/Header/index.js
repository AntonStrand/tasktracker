...
const Background = styled.div`
  ...
  @media (max-width: 380px) {
    ...
    props.showMenu ? '1em 1fr 1fr 1fr 1em' : '1em 1fr 1fr 1em'};
  }
`
...
const Header = ({ logOut, onMenuIconClick, showMenu }) => {
  ...
  return (
    <Background showMenu={showMenu}>
      <HamburgerIcon
        ...
        showMenu={showMenu}
      />
      <Logo src={logo} alt='TaskTracker' showMenu={showMenu} />
      <NavLink onClick={logOut} showMenu={showMenu}>
        Log out
      </NavLink>
    </Background>
  )
